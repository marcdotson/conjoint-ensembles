# This code implements a hierarchical MNL choice model with a multivariate normal distribution of heterogeneity via Stan.
...
# Run model.
out_test <- stan(
  file = "HBMNL.stan", data = Data, iter = 500, chains = 4,
...
# mcmc_combo(As.mcmc.list(out_test))
