...
# The lone summary statistic that we'll use to understand
# the observational space is a histogram of the observed
# counts.  Every sample from the generative ensemble yields
# its own summary histogram.
B <- 40
...
plot(1, type="n", main="Prior Predictive Histogram Samples",
     xlim=c(-0.5, B + 0.5), xlab="y", ylim=c(0, 50), ylab="") 
...
# We can use these samples to visualize the prior predictive
# distribution of summary histograms
...
plot(1, type="n", main="Prior Predictive Histogram Distribution",
